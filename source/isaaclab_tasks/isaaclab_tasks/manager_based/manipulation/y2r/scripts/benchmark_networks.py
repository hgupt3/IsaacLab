...
def main():
    ...
    parser.add_argument('--mlp_config', type=str,
                        default='IsaacLab/source/isaaclab_tasks/isaaclab_tasks/manager_based/manipulation/y2r/configs/agents/teacher_ppo.yaml')
    parser.add_argument('--pt_config', type=str,
                        default='IsaacLab/source/isaaclab_tasks/isaaclab_tasks/manager_based/manipulation/y2r/configs/agents/point_transformer_ppo.yaml')
